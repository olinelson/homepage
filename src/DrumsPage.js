    ...
    <Container style={{ background: 'black', color: 'white' }}>
          ...
          meta={
            <>
              <Icon
                color='red'
                size='large'
                href='https://www.youtube.com/user/MrOlibobo'
                name='youtube'
              />
              <Icon
                color='red'
                size='large'
                href='https://www.facebook.com/oli.nelson1'
                name='facebook'
              />
              <Icon
                color='red'
                size='large'
                href='https://www.instagram.com/olinelsondrums/'
                name='instagram'
              />
              <Icon
                color='red'
                size='large'
                href='https://medium.com/@olinelson93'
                icon='medium'
              />
            </>
          }
      ...
      <AlbumGrid>
        ...
        <Image
          ...
          src='images/wtrotwb.jpg'
          href='https://54records.com.au/hieronymus-trio-where-the-rest-of-the-world-begins'
        />
        <Image
          size='medium'
          href='https://trashcandream.bandcamp.com/track/out-on-the-sea-single-release'
          alt='trash can dream album cover'
          src='images/tcd.jpg'
        />
        <Image
          size='medium'
          href='https://54records.com.au/james-muller-big-band-okay'
          alt='sydney conservatorium jazz orchestra album cover'
          src='images/scjo.jpg'
        />
        <Image
          size='medium'
          alt='hieronymus trio album cover'
          href='https://hieronymustrio.bandcamp.com/releases'
          src='images/hrt.jpg'
        />
      </AlbumGrid>
      ...
      <Container style={{ background: 'rgba(0,0,0,0)' }} text>
        ...
        <blockquote cite='John Mcbeath | Toy Piano Records'>
          An astonishing big band made up of some of Australia’s most
          accomplished young lions
        </blockquote>

        <blockquote cite='Lynette Irwin | Scenestr.'>
